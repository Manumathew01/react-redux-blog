    ...
    <>
      <nav>
        <section className="right-nav-section">
          ...
          <p
            className={currentComponent === 'AllPostsComponent' ? 'nav-item active' : 'nav-item'}
            onClick={() => dispatch(switchToAllPostsComponent())}>
            Blogs
          </p>

          <p
            className={currentComponent === 'AddNewPostComponent' ? 'nav-item active' : 'nav-item'}
        ...
        <section className="left-nav-section">
          ...
          <p
            className={currentComponent === 'FavoriteComponent' ? 'nav-item active' : 'nav-item'}
